...
execute as @a[scores={DI_intro_00c1=1}] run summon armor_stand 15 193 0 {Invisible:1b,NoBasePlate:1b,Health:1f,Tags:["c2340389a"],DisabledSlots:4144959,equipment:{feet:{id:"minecraft:leather_boots",count:1b,components:{"minecraft:dyed_color":16746496}},legs:{id:"minecraft:leather_leggings",count:1b,components:{"minecraft:dyed_color":16746496}},chest:{id:"minecraft:leather_chestplate",count:1b,components:{"minecraft:dyed_color":16746496}}}}
execute as @a[scores={DI_intro_00c1=1}] run summon armor_stand 6 193 10 {Invisible:1b,NoBasePlate:1b,Health:1f,Tags:["c2340389b"],DisabledSlots:4144959,equipment:{feet:{id:"minecraft:leather_boots",count:1b,components:{"minecraft:dyed_color":16746496}}}}
...
execute as @a[scores={DI_intro_00c1=200}] run summon armor_stand 15 193 5 {Invisible:1b,NoBasePlate:1b,Health:1f,Tags:["c2340389c"],DisabledSlots:4144959,equipment:{feet:{id:"minecraft:leather_boots",count:1,components:{"minecraft:dyed_color":16746496}},legs:{id:"minecraft:leather_leggings",count:1,components:{"minecraft:dyed_color":16746496}},chest:{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:dyed_color":16746496}},head:{id:"minecraft:carved_pumpkin",count:1}}}
